...
--Question 7. Number of active Written Warning (WW) employee A has? (We are choosing Emp_id = 10)--
SELECT COUNT(*) FROM EMPLOYEE
INNER JOIN WRITTEN_WARNING ON WRITTEN_WARNING.WW_ID = EMPLOYEE.EMP_ID;

SELECT COUNT(*) FROM WRITTEN_WARNING 
WHERE EMP_ID = 10 AND IS_ACTIVE = 1;
